package DepoYonetimi.P11_depoYonetimi.depoYonetimi06;

import depoCalısma.depoYonetimi06.UrunTanimlama;
...
public class Method implements GirisCikisInterface {
    ...
    private static void rafaKoy() {
        ...
        if(urunler.keySet().contains(arananId)) {
            ...
            urunler.get(arananId).setRaf(Integer.parseInt(guncelRaf));
